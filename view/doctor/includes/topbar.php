    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          <img src="/HM1/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle" style="width:35px; height:35px;">
          <span class="d-none d-md-block dropdown-toggle ps-2 text-white">
            Dr. <?= htmlspecialchars($_SESSION['doctor_name'] ?? 'User'); ?>
          </span>
        </a>
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header text-center">
            <h6>Dr. <?= htmlspecialchars($_SESSION['doctor_name'] ?? 'User'); ?></h6>
            <span>HealthMate Doctor</span>
          </li>
          <li><hr class="dropdown-divider"></li>
          <li>
            <!-- absolute path keeps things simple -->
            <a class="dropdown-item d-flex align-items-center" href="/HM1/controller/doctor/logout.php">
